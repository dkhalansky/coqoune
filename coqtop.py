# This file was taken from the coquille project and slightly modified.
# It seems that this file was originally taken from
# https://github.com/epdtry/neovim-coq/blob/master/coqtop.py
import os
import re
import subprocess
...
def parse_error(xml):
    return re.sub(r"<state_id val=\"\d+\" />", '', ET.tostring(xml).decode("utf-8"))
